                    ...
                    steps {
                        withCredentials([
                            ...
                            script {
                                ...
                                $HOME/.local/bin/jfrog config add artifactory-server6 \
                                    --url=$JFROG_URL \
                                    --user=$JFROG_USER \
            ...
            steps {
                withCredentials([
                    ...
                    script {
                        ...
                        $HOME/.local/bin/jfrog rt build-publish --url=$JFROG_URL --server-id=artifactory-server6 "$JFROG_BUILD_NAME" "$BUILD_NUMBER"
